const { Illustration, TAU, Anchor, Group, Cone, Shape } = Zdog;
const url = 'https://ec.europa.eu/eurostat/en/web/products-eurostat-news/-/DDN-20190826-1';
const data = [
  {
    country: 'France',
    value: 450600078,
...
main
  ...
  .text(
    `In Europe, ${
      data[0].country
    } is the largest producer of ice cream. In terms of quantity, the top five countries can be summarised as follows:`
  );
...
table
  ...
  .append('tr')
  .selectAll('th')
  .data(['Country', 'Quantity (million liters)'])
  .enter()
  .append('th')
  .text(d => d);
table
